...
export const currentlyReading = {
  ...
  index: 1,
  bookList: [
    // TODO: Figure out a better way to handle multiple reads / listens
    // TODO: How to handle simulataneously reading and listening
    {
...
export const previouslyRead = {
  ...
  bookList: [
    ...
    },
    {
      ...
      author: 'Simon Sinek',
      imgSrc: './img/books/start_with_why.jpg',
      audioBook: true,
      readNo: 1,
    },
    {
    ...
    // Badge at the bottom right that says how many times read / listened
    {
      name: 'As a Man Thinketh',
      author: 'James Allen',
      imgSrc: './img/books/as_a_man_thinketh.jpg',
...
const futureReads = {
  ...
  bookList: [
    ...
    {
      name: 'Beyond the Goal: Theory of Constraints',
    },
    {
    ...
    {
      name: 'Disolving illusions',
    },
    {
      name: 'Chaos: Charles Manson, the CIA, and the Secret History of the Sixties',
    },
  ],
};
